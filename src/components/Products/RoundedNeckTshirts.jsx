...
import roundedTshirt from "../../../json/roundedTshirt.json";

const RoundedNeckTshirts = () => {
  const navigate = useNavigate();

  const handleUserClick = (roundedTshirt) => {
    // console.log("send the correct data from the users", roundedTshirt);
    navigate("/single-hoodies", {
      state: { hoodiesSingleData: roundedTshirt },
    });
