...
import zippers from "../../../json/zippers.json";

const Zipper = () => {
  const navigate = useNavigate();

  const handleUserClick = (zippers) => {
    // console.log("send the correct data from the users", zippers);
    navigate("/single-hoodies", { state: { hoodiesSingleData: zippers } });
